...
export const MacbookScroll = ({
  ...
  return (
    ...
    >
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] bg-transparent  dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
        <div className="h-10 w-full relative">
          <div className="absolute inset-x-0 mx-auto w-[80%] h-4 " />
        </div>
